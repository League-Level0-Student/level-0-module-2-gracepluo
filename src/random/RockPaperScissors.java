...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			rockImage = new ImageIcon(getClass().getResource("rockImage.jpg"));
			paperImage = new ImageIcon(getClass().getResource("paperImage.jpg"));
    ...
    Random neko = new Random();   
    int num = neko.nextInt(3);
